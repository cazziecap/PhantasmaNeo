...
namespace Neo.SmartContract
{
    public class PhantasmaContract : Framework.SmartContract
    {
        ...
        public static string Symbol() => "SOUL9";
        ...
        public static readonly byte[] Sale1_Address      = "ATbrcGyvRNU8QDbEZ8WV2QAdzzBzF1eK9B".ToScriptHash();
        public static readonly byte[] Airdrop_Address    = "ASsMdsqCaSjkjeTHaBsVKeiSeJULqeGp9D".ToScriptHash();
        ...
        public const ulong sale1_supply = 6316537 * soul_decimals; // sale1 token amount
        ...
        public const ulong token_initial_cap = 1100 * token_swap_rate; // max tokens than an individual can buy from to the sale in the first round, guaranteed
        ...
        public const uint ico_start_time = 1; 
        public const uint ico_war_time = 1927033600;
        public const uint ico_end_time = ico_war_time;
        ...
        public static BigInteger WhitelistCheckOne(byte[] address)
        {
            if (!ValidateAddress(address)) return 0;
        ...
        private static BigInteger CheckPurchaseAmount(byte[] sender, BigInteger neo_value, bool apply)
        {
            ...
            var whitelist_cap = Storage.Get(Storage.CurrentContext, whitelist_key).AsBigInteger();
            if (whitelist_cap <= 0) // not whitelisted
            {
